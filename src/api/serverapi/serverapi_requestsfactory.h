...
namespace serverapi_requests_factory
{
    ...
    BaseRequest *session(const std::string &authHash, const std::string &appleId, const std::string &gpDeviceId, std::int64_t invRev, std::int32_t backup, RequestFinishedCallback callback);
